...
const Nav = ({ minimal, showModal, setShowModal, bgColor }) => {
  ...
  return (
    <>
    {
      ...
      <GiHamburgerMenu onClick={()=>setOpen(!open)}/>
        ...
        <div className={`${open?'fixed':'hidden'} flex justify-center w-[100%]`}>
        ...
        <div className='flex  flex-col md:w-[40%] w-[90%]  gap-1 md:text-left text-center'>
                <h1 className='text-xl font-bold md:text-left text-left mt-[10px]'>Contact Us</h1>
